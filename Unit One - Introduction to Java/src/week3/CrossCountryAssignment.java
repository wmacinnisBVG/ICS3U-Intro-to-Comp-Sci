...
public class CrossCountryAssignment {
    public static void main(String[] args) {
        ...
        System.out.println("| Time at end of the race (Split 3): "+secondsToMinutes(runnerOneSplit3)+" |");
        System.out.println("-----------------------------------------------");
        System.out.println("Total time to finish race: "+runnerOneFinalTime+"         ");
        ...
        System.out.println("| Time at end of the race (Split 3): "+secondsToMinutes(runnerTwoSplit3)+" |");
        System.out.println("-----------------------------------------------");
        System.out.println("Total time to finish race: "+runnerTwoFinalTime+"         ");
        ...
        System.out.println("| Time at end of the race (Split 3): "+secondsToMinutes(runnerThreeSplit3)+" |");
        System.out.println("-----------------------------------------------");
        System.out.println("Total time to finish race: "+runnerThreeFinalTime+"         ");
    ...
    private static String secondsToMinutes(double numOfSeconds) {
        int miliseconds = (int)(numOfSeconds*1000)%1000;
        String newMiliseconds = ""+miliseconds;
        String formattedNewMiliseconds = ("000" + newMiliseconds).substring(newMiliseconds.length());
        ...
        return minutes+":"+formattedNewSeconds+"."+formattedNewMiliseconds;
    }
